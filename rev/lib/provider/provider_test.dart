...
class Questions {
  ...
  static currentQuestionChoice(int questionNum) =>
      _question[questionNum]["choices"];

  static String getQuestionExam(int questionNum) {
    Map<String, dynamic> temp = _question[questionNum];
    return temp["exam"];
  }
