        ...
        children: [
          Expanded(
            child: TextButton(onPressed: () {
              if(Questions.submitList[_questionProvider.currentQuestion].contains(Questions.answerList[_questionProvider.currentQuestion][index[i].toString()]))
                Questions.submitList[_questionProvider.currentQuestion].remove(Questions.answerList[_questionProvider.currentQuestion][index[i].toString()]);
              else
                Questions.submitList[_questionProvider.currentQuestion].add(Questions.answerList[_questionProvider.currentQuestion][index[i].toString()]);
              _questionProvider.notifyListeners();
            }, child: Text(index[i].toString()),style: TextButton.styleFrom(
                alignment: Alignment.centerLeft,
                primary: Questions.submitList[_questionProvider.currentQuestion].contains(Questions.answerList[_questionProvider.currentQuestion][index[i].toString()]) ? ColorRev.g3 : Colors.black,
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: getAnsweer(Questions.answerList[_questionProvider.currentQuestion].keys.toList()),
                ),
              ),
            ),
            Card(
